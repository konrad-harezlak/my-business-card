        ...
        return (
            <div className='contact-container'>
                ...
                <div className='bussines-card'>
                    ...
                    <div className='card-number-left-top'><p><FontAwesomeIcon icon={faPhone} /> <a href="tel:">000 000 000</a></p></div>
                    <div className='card-adres-right-top'><p><FontAwesomeIcon icon={faHouse} /> <a href="https://www.google.com/maps/" target="_blank" rel="noopener noreferrer">Katowice</a></p></div>
